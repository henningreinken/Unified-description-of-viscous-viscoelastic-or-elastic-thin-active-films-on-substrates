...
nuP = nuPStart
stepsnuP = round((nuPStart - nuPEnd)/nuPStep)
...
tEnd = stepsnuP*tEndnuP

numSteps = round(tEnd/dt) 

numStepsnuP = round(tEndnuP/dt)
...
for nStep in range(0,numSteps):
	...
	# reduce nuP to progress into the hysteretic regime
	if nStep%numStepsnuP == 0 and nStep >= 1:
